...
### :ghost: Обо мне:
Я **Junior Frontend разработчик**. Мой путь начинался с работы официантом-барменом в ресторане при отеле Ibis kitchen (Санкт-Петербург). После пандемии covid-19 я устроился на работу курьером в Яндекс Еде, где укрепился на 2 года, а через какое-то время увлекся криптой и web-разработкой. Параллельно с обучением в университете, на онлайн-курсах, изучал такие языки, как: **Java, C++, C#, Python**. На данный момент работаю в компании Inbox Marketing в Санкт-Петербурге в роли старшего верстальщика и project manager нескольких проектов, занимаюсь разработкой и тестированием email-рассылок (созданием html- и amp-писем). На досуге изучаю английский и пробую себя в motion-design.

**За последние 2 года я:**
+ :pushpin: *Прошел курсы по Web-программированию, Python и DataBase*
+ :briefcase: *Сверстал много сайтов и email-писем*
